...
if (! function_exists('safelyCreditBrijx')) {
    function safelyCreditBrijx(Wallet|int $wallet, float $amount)
    {
...
if (! function_exists('safelyDebitBrijx')) {
    function safelyDebitBrijx(Wallet|int $wallet, float $amount)
    {
        $id = ($wallet instanceof Wallet) ? $wallet->id : $wallet;
...
if (! function_exists('safelyCredit')) {
    function safelyCredit(Wallet|int $wallet, float $amount)
    {
        $id = ($wallet instanceof Wallet) ? $wallet->id : $wallet;
...
if (! function_exists('safelyDebit')) {
    function safelyDebit(Wallet|int $wallet, float $amount)
    {
        $id = ($wallet instanceof Wallet) ? $wallet->id : $wallet;
...
if (! function_exists('safelyCreditRnBal')) {
    function safelyCreditRnBal(Wallet|int $wallet, float $amount)
    {
        $id = ($wallet instanceof Wallet) ? $wallet->id : $wallet;
...
if (! function_exists('safelyDebitRnBal')) {
    function safelyDebitRnBal(Wallet|int $wallet, float $amount)
    {
        $id = ($wallet instanceof Wallet) ? $wallet->id : $wallet;
...
if (! function_exists('safelyDebitOverdraft')) {
    function safelyDebitOverdraft(Wallet|int $wallet, float $amount)
    {
        $id = ($wallet instanceof Wallet) ? $wallet->id : $wallet;
...
if (! function_exists('safelyCreditOverdraft')) {
    function safelyCreditOverdraft(Wallet|int $wallet, float $amount)
    {
        $id = ($wallet instanceof Wallet) ? $wallet->id : $wallet;
...
// for reversal
if (! function_exists('safelyCreditForFailedTransaction')) {
    function safelyCreditForFailedTransaction(Wallet|int $wallet, float $amount)
    {
        $id = ($wallet instanceof Wallet) ? $wallet->id : $wallet;
...
// for reversal
if (! function_exists('safelyDebitForFailedTransaction')) {
    function safelyDebitForFailedTransaction(Wallet|int $wallet, float $amount)
    {
        $id = ($wallet instanceof Wallet) ? $wallet->id : $wallet;
